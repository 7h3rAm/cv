...
\textcolor{Gray}{\faIcon{$contact.email.faicontext$}} \href{mailto:$contact.email.url$}{$contact.email.text$} • \textcolor{OliveDrab}{\faIcon{$contact.blog.faicontext$}} \href{$contact.blog.url$}{$contact.blog.text$} • \textcolor{MediumTurquoise}{\faIcon{$contact.twitter.faicontext$}} \href{$contact.twitter.url$}{$contact.twitter.text$} • \textcolor{SteelBlue}{\faIcon{$contact.linkedin.faicontext$}} \href{$contact.linkedin.url$}{$contact.linkedin.text$}\\[.3cm]
$intro$
